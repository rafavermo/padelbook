...
<form id="formulario_evento" name="crea_evento" action="valida_crear_evento.php" method="post" onSubmit="return valida_crea_evento(this);">
	<input type="hidden" id="ciudad_evento" name="ciudad_evento"  value="<?=$formularioEvento["ciudad"]?>" />
